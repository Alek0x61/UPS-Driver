...
#define SOC_REFRESH_DELAY                      5
#define SOC_ADJUSTMENT_STEP                    0.01
#define SOC_CALIBRATION_THRESHOLD              0.4
#define DELTA_TIME_CHARGING_ADJUSTMENT         0.6
#define DELTA_TIME_DISCHARGING_ADJUSTMENT      0.7
